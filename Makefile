...
PROJ_OBJ_CF2 += randomizedTimerFunctions.o randomizedTimerEngine.o
PROJ_OBJ_CF2 += leakyBucketEngine.o
PROJ_OBJ_CF2 += lpsTwrTag.o
PROJ_OBJ_CF2 += lpsTdoa2Tag.o
PROJ_OBJ_CF2 += lpsTdoa3Tag.o lpsTdoaTagEngine.o lpsTdoaTagStats.o
PROJ_OBJ_CF2 += lpsTwrSwarmTag.o TwrSwarmAlgorithm.o TwrSwarmAlgorithmBlocks.o TwrSwarmDebug.o TwrSwarmDump.o
...
LDFLAGS = --specs=nano.specs --specs=nosys.specs $(PROCESSOR) -Wl,--print-memory-usage,-Map=$(PROG).map,--cref,--gc-sections,--undefined=uxTopUsedPriority
